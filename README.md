...
> I build **AI-powered, production-grade systems**.  
> Not demos. Not hype. **Software that holds up in the real world.**

I focus on:
- backend architecture that doesn’t crumble  
- frontends that feel fast, not flashy  
- **GenAI applied with intent**, not buzzwords  
- systems that scale without becoming unmaintainable  
...
<p>
<b>Bias:</b> Backend-first thinking · Clean APIs · AI as leverage · Cloud-native
</p>
...
- Production-grade GenAI patterns  
- Performance tuning  
...
<b>If it scales, it ships. If it breaks, I fix it.</b>
